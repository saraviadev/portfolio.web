...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 glass border-b border-white/5 transition-all duration-300">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden fixed inset-0 top-16 z-[99] flex flex-col justify-between p-6 border-t border-white/5 animate-in fade-in slide-in-from-top duration-200 overflow-y-auto" style={{ backgroundColor: 'rgba(0, 0, 0, 0.95)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }}>
